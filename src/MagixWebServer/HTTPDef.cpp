...
const char* g_HTTP_Content_NotFound = "404 Not Found - MagixWebServer";
const char* g_HTTP_Bad_Request = "400 Bad Request - MagixWebServer";
const char* g_HTTP_Bad_Method = "405 Method Not Allowed - MagixWebServer";
const char* g_HTTP_Server_Error = "500 Oops, server error - MagixWebServer";
const char* g_HTTP_Forbidden = "403 Forbidden - MagixWebServer";
const char* g_HTTP_Server_Busy = "503 Service Unavailable, try again later - MagixWebServer";
